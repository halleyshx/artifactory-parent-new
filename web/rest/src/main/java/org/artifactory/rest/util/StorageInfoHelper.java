...
public class StorageInfoHelper {
    ...
    private void addExtraFileInfo(RestFileInfo fileInfo, String uri) {
        ...
        String originalSha2 = sha2 != null ? sha2.getOriginal() : checksumInfo.getSha256();
        String originalMd5 = md5 != null ? md5.getOriginal() : checksumInfo.getMd5();
        fileInfo.checksums = new RestFileInfo.Checksums(checksumInfo.getSha1(), checksumInfo.getSha256(), checksumInfo.getMd5());
        fileInfo.originalChecksums = new RestFileInfo.Checksums(originalSha1, originalSha2, originalMd5);
    }
