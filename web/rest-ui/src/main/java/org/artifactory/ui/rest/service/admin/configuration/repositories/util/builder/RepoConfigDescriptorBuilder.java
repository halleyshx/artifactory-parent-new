...
public class RepoConfigDescriptorBuilder {
    ...
    private void buildAndSetXrayConfig(RealRepoDescriptor descriptor, LocalBasicRepositoryConfigModel basic) {
        ...
        if (xrayConfigModel != null) {
            ...
            xrayConfig.setMinimumBlockedSeverity(xrayConfigModel.getMinimumBlockedSeverity());
            if (StringUtils.isBlank(xrayConfig.getMinimumBlockedSeverity())) {
                xrayConfig.setBlockUnscannedArtifacts(false);
            } else {
                xrayConfig.setBlockUnscannedArtifacts(xrayConfigModel.isBlockUnscannedArtifacts());
            }
        }
