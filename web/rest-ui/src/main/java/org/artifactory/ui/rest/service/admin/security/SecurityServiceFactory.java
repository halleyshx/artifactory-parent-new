...
import org.artifactory.ui.rest.service.artifacts.browse.treebrowser.tabs.permission.GetEffectivePermissionsByEntityService;
...
public abstract class SecurityServiceFactory {
    ...
    @Lookup
    public abstract GetEffectivePermissionsByEntityService getGetEffectivePermissionServiceByEntity();
    @Lookup
