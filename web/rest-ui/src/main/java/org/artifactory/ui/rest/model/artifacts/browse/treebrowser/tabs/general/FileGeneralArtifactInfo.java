...
import org.artifactory.ui.rest.model.artifacts.browse.treebrowser.tabs.general.dependecydeclaration
...
public class FileGeneralArtifactInfo extends GeneralArtifactInfo {
    ...
    public void populateGeneralData() {
        ...
        LocalRepoDescriptor localRepoDescriptor = repoService.localCachedOrDistributionRepoDescriptorByKey(repoPath.getRepoKey());
        super.setInfo(new org.artifactory.ui.rest.model.artifacts.browse.treebrowser.tabs.general.info.FileInfo(repoPath));
