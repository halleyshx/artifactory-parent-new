...
public class RepoConfigModelBuilder {
    ...
    private TypeSpecificConfigModel createVirtualTypeSpecific(RepoType type, VirtualRepoDescriptor descriptor) {
        ...
        switch (type) {
            ...
            case Puppet:
                ...
                break;
            case Docker:
                typeSpecific = new DockerTypeSpecificConfigModel();
                break;
            case YUM:
    ...
    private XrayRepoConfigModel getXrayConfig(XrayRepoConfig xrayRepoConfig) {
        ...
        if (xrayRepoConfig != null) {
            ...
            model.setBlockUnscannedArtifacts(xrayRepoConfig.isBlockUnscannedArtifacts());
            model.setMinimumBlockedSeverity(xrayRepoConfig.getMinimumBlockedSeverity());
        }
        return model;
    }
