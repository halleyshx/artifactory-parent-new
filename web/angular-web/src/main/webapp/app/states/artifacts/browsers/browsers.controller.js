...
export class BrowsersController {
    constructor($timeout, $scope, $stateParams, $state, TreeBrowserDao, JFrogEventBus, hotkeys, ArtifactoryState, ArtifactoryStorage) {
    ...
    isFavoritesEnabled() {
        ...
        return !!(favRepos && favRepos.favoritesRepos && favRepos.favoritesRepos.length);
    }
