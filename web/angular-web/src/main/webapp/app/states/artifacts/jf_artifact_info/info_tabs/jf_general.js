...
class jfGeneralController {
    ...
    shouldDisplayInfoEntry(key){
        return key != 'xrayIndexStatus' &&
                key != 'xrayIndexStatusLastUpdatedTimestamp' &&
                key != 'xrayAlertIgnored' &&
                key != 'xrayAlertLastUpdatedTimestamp' &&
                key != 'xrayAlertTopSeverity' &&
                key != 'licenses' &&
                key != 'filtered' &&
                key != 'smartRepo' &&
                ...
                key != 'xrayBlocked' &&
                key != 'xrayUnscanned' &&
                key != 'xrayEnabledForRepo' &&
                key != 'repoBlocksXrayUnscanned' &&
