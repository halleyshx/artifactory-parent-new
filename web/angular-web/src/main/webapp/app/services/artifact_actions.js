...
*/
    ...
    _doIgnoreAlert(node) {
        this._performActionInServer('ignoreAlert', node, {}, {param: 'true'})
                .then((response) => {
                    this.JFrogEventBus.dispatch(EVENTS.ACTION_IGNORE_ALERT, node);
                });
    }

    _doUnignoreAlert(node) {
        this._performActionInServer('ignoreAlert', node, {}, {param: 'false'})
                .then((response) => {
                    this.JFrogEventBus.dispatch(EVENTS.ACTION_UNIGNORE_ALERT, node);
                });
    }
