...
public abstract class HttpClientUtils {
    ...
    /**
     * Return a filtered error message to prevent SSRF vulnerability {@see RTFACT-13471}
     * when using as a Http response body.
     */
    public static String getFilteredErrorMessage(Throwable e) {
        return e.getCause() == null ? getErrorMessage(e) : e.getCause().getMessage();
    }
