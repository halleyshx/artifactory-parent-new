...
public interface BuildAddon extends Addon {
     ...
     */
    @Lock
    void discardOldBuildsByDate(String buildName, BuildRetention buildRetention, BasicStatusHolder multiStatusHolder, boolean async);
     ...
     */
    @Lock
    void discardOldBuildsByCount(String buildName, BuildRetention discard, BasicStatusHolder multiStatusHolder, boolean async);
