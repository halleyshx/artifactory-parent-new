...
public interface AccessService extends ImportableExportable, ReloadableBean {
    ...
    void initAccessService(boolean doBootstrap);
     ...
     */
    @Nonnull
    CreatedTokenInfo createNoPermissionToken(@Nonnull TokenSpec tokenSpec, @Nullable String extraData);
     ...
     */
    void importSecurityEntities(SecurityInfo securityInfo);
