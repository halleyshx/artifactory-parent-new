 ...
 * @author Gidi Shabat
 */
public class MockHomeSharedConverter implements ArtifactoryConverterAdapter {
    private String path;

    public MockHomeSharedConverter(String path) {
        this.path = path;
    }
    ...
    public boolean isInterested(CompoundVersionDetails source, CompoundVersionDetails target) {
        return source == null || source.getVersion().before(target.getVersion());
    }
