...
//    @Test
    ...
    public static void assertPropsContentMatchBuildEnvironment(ArtifactoryVersionReader.VersionPropertiesContent propsContent) {
        ...
        String jenkinsHome = (envUser || System.getenv("HOME").toLowerCase().contains("jenkins"))
        ...
        if (StringUtils.isBlank(jenkinsHome)) {
            ...
            Assert.assertEquals(propsContent.versionString, "5.x-SNAPSHOT");
            Assert.assertEquals(propsContent.buildNumberString, "LOCAL");
            Assert.assertEquals(propsContent.revisionString, "dev");
            ...
            if (propsContent.versionString.contains(".x_") || propsContent.versionString.contains(".x.")) {
                ...
                Assert.assertEquals(versionInEnum.getValue(), "99.99.99");
                ...
                Matcher releaseVersionMatcher = ArtifactoryVersion.RELEASE_VERSION_PATTERN.matcher(releaseVersion);
