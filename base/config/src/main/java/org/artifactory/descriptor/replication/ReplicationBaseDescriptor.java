...
@XmlType(name = "ReplicationBaseType", propOrder = {"enabled", "cronExp", "syncDeletes", "syncProperties", "pathPrefix",
        "repoKey", "enableEventReplication", "replicationKey"}, namespace = Descriptor.NS)
public abstract class ReplicationBaseDescriptor implements TaskDescriptor {
    ...
    public boolean equals(Object o) {
        ...
        return replicationKey != null ? replicationKey.equals(that.replicationKey) : that.replicationKey == null;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (replicationKey != null ? replicationKey.hashCode() : 0);
