 ...
 */
@XmlRootElement
@XmlType(name = "SecurityType", propOrder = {"anonAccessEnabled", "anonAccessToBuildInfosDisabled",
        "hideUnauthorizedResources", "passwordSettings", "ldapSettings", "ldapGroupSettings", "httpSsoSettings",
        "crowdSettings", "samlSettings", "oauthSettings", "signingKeysSettings", "userLockPolicy", "sshServerSettings",
