...
public class CentralConfigReader {
    ...
    /**
     * @see CentralConfigReader#read(String, boolean)
     */
    public MutableCentralConfigDescriptor read(File configFile) {
        return read(Files.readFileToString(configFile), false);
    }
     ...
     */
    public MutableCentralConfigDescriptor read(String artifactoryConfigXml, boolean withValidation) {
        ...
        return JaxbHelper.readConfig(artifactoryConfigXml, withValidation);
    }
