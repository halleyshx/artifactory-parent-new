...
@XmlType(name = "LdapSettingType",
        propOrder = {"key", "enabled", "ldapUrl", "userDnPattern", "search", "autoCreateUser", "emailAttribute", "ldapPoisoningProtection", "allowUserToAccessProfile" },
...
public class LdapSetting implements Descriptor {
    ...
    public boolean identicalConfiguration(LdapSetting that) {
        ...
        if (ldapPoisoningProtection != null ? !ldapPoisoningProtection.
