...
public enum MimeTypesVersion implements SubConfigElementVersion {
    ...
    v8(ArtifactoryVersion.v410, ArtifactoryVersion.v501, new PythonMimeTypeConverter()),
    v9(ArtifactoryVersion.v5011, ArtifactoryVersion.v548, new Sha2ChecksumMimeTypeConverter()),
    v10(ArtifactoryVersion.v550m005, ArtifactoryVersion.getCurrent());
