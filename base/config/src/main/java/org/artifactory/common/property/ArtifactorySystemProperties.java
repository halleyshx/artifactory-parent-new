...
public class ArtifactorySystemProperties {
    ...
    private static final ImmutableMap<String, PropertyMapper> DEPRECATED =
            ImmutableMap.<String, PropertyMapper>builder()
                    ...
                    .put("bintray.system.api.key", new MovedToConfigPropertyMapper
                            ("The bintray config section in the admin page"))
                    .put("artifactory.security.useBase64", new NullPropertyMapper())
                    .put("artifactory.security.authentication.encryptedPassword.surroundChars", new NullPropertyMapper())
                    .build();
    /**
    ...
    public void loadArtifactorySystemProperties(File systemPropertiesFile, @Nullable CompoundVersionDetails runningVersion) {
        ...
        if (runningVersion != null) {
            newArtifactoryProperties.put(ConstantValues.artifactoryVersion, runningVersion.getVersionName());
            newArtifactoryProperties.put(ConstantValues.artifactoryRevision, runningVersion.getRevision());
            newArtifactoryProperties.put(ConstantValues.artifactoryBuildNumber, runningVersion.getBuildNumber());
            newArtifactoryProperties.put(ConstantValues.artifactoryTimestamp, Long.toString(runningVersion.getTimestamp()));
        }
