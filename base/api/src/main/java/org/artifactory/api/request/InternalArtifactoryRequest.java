...
import org.artifactory.api.util.StringKeyIgnoreCaseHashMap;
...
public class InternalArtifactoryRequest extends ArtifactoryRequestBase {
    ...
    private boolean forcePropertySync;

    private Map<String, String> headers = new StringKeyIgnoreCaseHashMap<>();
    ...
    public boolean isForcePropertySync() {
        return forcePropertySync;
    }
    ...
    public void setForcePropertiesSync(boolean forcePropertySync) {
        this.forcePropertySync = forcePropertySync;
    }
    ...
    public String getParameter(String name) {
        ...
        if (PARAM_FORCE_PROPERTIES_SYNC.equals(name)) {
            return String.valueOf(forcePropertySync);
        }
        return null;
    }
