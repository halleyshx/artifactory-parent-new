...
public interface UserGroupService {
    ...
    void updateUser(MutableUserInfo user, boolean activateListeners, boolean encryptProperties);
    ...
    void encryptDecryptUserProps(String propKey, boolean encrypt);

    /**
     * Map of group id to multiple users ids
     */
    Multimap<String, String> getAllUsersInGroups();
