...
public interface RepositoryService extends ImportableExportable {
    ...
    /**
     * Retrieves item properties by the item info. Prefer this moe efficient method over
     * {@link RepositoryService#getProperties(RepoPath)} whenever possible.
     *
     ...
     */
    FolderSummeryInfo getArtifactCountAndSize(@NotNull RepoPath repoPath);
    ...
    /**
     * Searches Artifactory for an artifact that has a property "sha256"={@param sha2} and returns its sha1 if exists.
     */
    @Nullable
    @Deprecated
    String getSha1BySha2Property(String sha2);
