...
@JobCommand(singleton = true, schedulerUser = TaskUser.SYSTEM, manualUser = TaskUser.SYSTEM,
        ...
        commandsToStop = {
                ...
                @StopCommand(strategy = PAUSE, commandName = ScheduleJobEnum.SHA256_MIGRATION_JOB),
                @StopCommand(strategy = PAUSE, commandName = ScheduleJobEnum.PATH_CHECKSUM_MIGRATION_JOB),
        })
