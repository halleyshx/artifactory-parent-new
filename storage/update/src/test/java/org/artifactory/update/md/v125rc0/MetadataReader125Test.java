...
public class MetadataReader125Test extends MetadataReaderBaseTest {
    ...
    public void readFolderMetadata() {
        ...
        File folderMetadataDirectory = ResourceUtils
                .getResourceAsFile("/metadata/v125rc0/commons-cli.artifactory-metadata");
    ...
    public void readFileMetadata() {
        MetadataReader125 reader = new MetadataReader125();
        File fileMetadataDirectory = ResourceUtils
                .getResourceAsFile("/metadata/v125rc0/commons-cli-1.0.pom.artifactory-metadata");
        BasicStatusHolder status = new BasicStatusHolder();
