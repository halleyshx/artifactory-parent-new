...
public class NodesDao extends BaseDao {
    ...
    public Integer getItemType(NodePath path) throws SQLException {
        ResultSet resultSet = null;
        try {
            resultSet = jdbcHelper.executeSelect("SELECT node_type FROM nodes " +
    ...
    public FolderSummeryNodeInfo getFilesCountAndSize(@NotNull NodePath nodePath) throws SQLException {
