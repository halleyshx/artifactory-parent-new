...
public class ArchiveEntriesDao extends BaseDao {
    ...
    @Autowired
    public ArchiveEntriesDao(JdbcHelper jdbcHelper, ArtifactoryDbProperties dbProperties) {
        super(jdbcHelper);
    ...
    public boolean createIndexedArchive(String archiveSha1, long indexedArchiveId) throws SQLException {
        int updateCount = jdbcHelper.executeUpdate("INSERT INTO indexed_archives " +
                        "(archive_sha1, indexed_archives_id) VALUES (?, ?)", archiveSha1, indexedArchiveId);
        return updateCount > 0;

    }

    public boolean createArchivePath(long archivePathId, String entryPath) throws SQLException {
        int updateCount = jdbcHelper.executeUpdate("INSERT INTO archive_paths (path_id, entry_path) VALUES (?, ?)",
    ...
    public boolean createArchiveName(long archiveNameId, String entryName) throws SQLException {
        int updateCount = jdbcHelper.executeUpdate("INSERT INTO archive_names (name_id, entry_name) VALUES (?, ?)",
     ...
     */
    public boolean createIndexedArchivesEntries(long indexedArchiveId, long archivePathId, long archiveNameId) throws SQLException {
        int updateCount = jdbcHelper.executeUpdate("INSERT INTO indexed_archives_entries " +
                        "(indexed_archives_id, entry_path_id, entry_name_id) VALUES (?, ?, ?)",
