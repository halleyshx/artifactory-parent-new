...
public class AclsDao extends BaseDao {
    ...
    public int createAcl(Acl acl) throws SQLException {
        int res = jdbcHelper.executeUpdate("INSERT INTO acls " +
                        "(acl_id, perm_target_id, modified, modified_by) " +
                        "VALUES( ?, ?, ?, ?)",
    ...
    private int insertAce(Ace ace) throws SQLException {
        return jdbcHelper.executeUpdate("INSERT INTO aces " +
                        "(ace_id, acl_id, mask, user_id, group_id) " +
                        "VALUES(?, ?, ?, ?, ?)",
