...
import org.artifactory.storage.db.aql.parser.elements.high.level.domain.*;
...
public class ParserToAqlAdapter extends AqlAdapter {
    ...
    private void handleAction(ParserToAqlAdapterContext context) {
        gotoAction(context);
        if (!context.hasNext()) {
            return;
        }
    ...
    private void assignActionValue(ParserToAqlAdapterContext context, AqlAction action) {
    ...
    private void assignActionPropKeys(ParserToAqlAdapterContext context, AqlAction action) {
        if (!AqlPropertyAction.class.isAssignableFrom(action.getClass())) {
            return;
        }
    ...
    private void markDryRunAction(ParserToAqlAdapterContext context, AqlAction action) {
    ...
    private void handleDefaultCriteriaProperty(ParserToAqlAdapterContext context) throws AqlException {
        // Remove element from parser result elements
        context.decrementIndex(1);
        // Get the field sub domains
        List<AqlDomainEnum> subDomains = resolveSubDomains(context);
    ...
    private void handleKeyCriteriaProperty(ParserToAqlAdapterContext context) throws AqlException {
        // Remove element from parser result elements
        context.decrementIndex(1);
        // Get the field sub domains
        List<AqlDomainEnum> subDomains = resolveSubDomains(context);
    ...
    private void handleValueCriteriaProperty(ParserToAqlAdapterContext context) throws AqlException {
        // Remove element from parser result elements
        context.decrementIndex(1);
        // Get the field sub domains
        List<AqlDomainEnum> subDomains = resolveSubDomains(context);
    ...
    private void handleEqualsCriteriaProperty(ParserToAqlAdapterContext context) throws AqlException {
        // Remove element from parser result elements
        context.decrementIndex(1);
        // Get the field sub domains
        List<AqlDomainEnum> subDomains = resolveSubDomains(context);
    ...
    private void handleEqualsKeyCriteriaProperty(ParserToAqlAdapterContext context) throws AqlException {
        // Remove element from parser result elements
        context.decrementIndex(1);
        // Get the field sub domains
        List<AqlDomainEnum> subDomains = resolveSubDomains(context);
    ...
    private void handleEqualsValueCriteriaProperty(ParserToAqlAdapterContext context) throws AqlException {
        // Remove element from parser result elements
        context.decrementIndex(1);
        // Get the field sub domains
        List<AqlDomainEnum> subDomains = resolveSubDomains(context);
    ...
    private AqlPhysicalFieldEnum resolvePhysicalField(ParserToAqlAdapterContext context) {
        Pair<ParserElement, String> element = context.getElement();
    ...
    private void gotoAction(ParserToAqlAdapterContext context) {
        context.resetIndex();
