...
public class BuildsDaoTest extends BuildsDaoBaseTest {
    ...
    @Test(priority = -1)
    public void testGetLatestBuildIds() throws SQLException {
        List<BuildIdEntity> latestBuildIds = buildsDao.getLatestBuildIds(null, null, null, null);
        assertEquals(latestBuildIds.size(), 2);
        Map<String, BuildIdEntity> builds = latestBuildIds.stream().collect(Collectors.toMap(BuildIdEntity::getBuildName, build -> build));
    ...
    public void testCreateBuildSameNameAndNumber() throws SQLException, UnsupportedEncodingException {
        ...
        otherBa2.setProperties(new HashSet<>());
        otherBa2.setPromotions(new HashSet<>());
    ...
    public void testCreateBuildSameNameNumberDate() throws SQLException, UnsupportedEncodingException {
        ...
        badBuild.setProperties(new HashSet<>());
        badBuild.setPromotions(new HashSet<>());
...
/*    public void testFindBuildsForArtifactSHA2Checksum() throws SQLException {
        Collection<BuildEntity> builds = buildsDao.findBuildsForArtifactChecksum(ChecksumType.sha256,
    ...
    //TODO [by dan]: kicked out build dependencies sha2 from db because of performance
/*    public void testFindBuildsForDependencySHA2Checksum() throws SQLException {
        Collection<BuildEntity> builds = buildsDao.findBuildsForDependencyChecksum(ChecksumType.sha256,
                "xxxx23029162f3b2dc51f512cb64bce8cb6913ed6e540f23ec567d898f60xxxx");
