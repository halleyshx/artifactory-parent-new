...
public class BuildDependenciesDaoTest extends BuildsDaoBaseTest {
    ...
    //TODO [by dan]: kicked out build artifacts sha2 from db because of performance
    //private static final String SHA2_SUFFIX = "05a611471bcc6b98995159fafcc56234bdf9aa2d4fbbd7e6503d70c91427171";
    ...
    public void fullDelete() throws SQLException {
        ...
        assertEquals(buildDependenciesDao.deleteAllBuildDependencies(), 4);
    ...
    public void testCreateSimpleDependency() throws SQLException, UnsupportedEncodingException {
        ...
        BuildDependency bd = new BuildDependency(1001L, 101L, "group:dep1:1.0", "compile,test", "jar",
                "1" + SHA1_SUFFIX, "1" + MD5_SUFFIX, null /*"1" + SHA2_SUFFIX*/);
    ...
    private void assertFoundDependency1001(List<BuildDependency> dependencies) {
        ...
        Assert.assertEquals(buildDependency.getSha2(), null /*"1" + SHA2_SUFFIX*/);
    }
    ...
    public void testCreateMultipleDependencies() throws SQLException, UnsupportedEncodingException {
        ...
        bds.add(new BuildDependency(2001L, 201L, "apache:log4j:1.0",
                (String) null, "dll", "a" + SHA1_SUFFIX, "a" + MD5_SUFFIX, null /*"a" + SHA2_SUFFIX*/));
        bds.add(new BuildDependency(2002L, 201L, "jfrog:bi:2.2.0", (String) null,
                "zip", "b" + SHA1_SUFFIX, "b" + MD5_SUFFIX, null /*"b" + SHA2_SUFFIX*/));
        bds.add(new BuildDependency(2021L, 202L, "g:a:v", (String) null,
                "jar", "b" + SHA1_SUFFIX, "b" + MD5_SUFFIX, null /*"b" + SHA2_SUFFIX*/));
        bds.add(new BuildDependency(2022L, 202L, "d:b:6", (String) null,
                "pom", "c" + SHA1_SUFFIX, "c" + MD5_SUFFIX, null /*"c" + SHA2_SUFFIX*/));
    ...
    public void testCreateNullChecksumsDependencies() throws SQLException, UnsupportedEncodingException {
        ...
        bds.add(new BuildDependency(4001L, 401L, "apache:log4j:1.1", (String) null,
                "dll", null, "e" + MD5_SUFFIX, null));
        bds.add(new BuildDependency(4021L, 402L, "jfrog:bi:2.2.1", (String) null,
                null, "f" + SHA1_SUFFIX, null, null));
        bds.add(new BuildDependency(4023L, 402L, "jfrog:bi:2.2.1", (String) null,
                null, null, null, null /*"f" + SHA2_SUFFIX*/));
        bds.add(new BuildDependency(4022L, 402L, "jfrog:bi:2.2.1", (String) null,
                null, null, null, null));
        Assert.assertEquals(buildDependenciesDao.createBuildDependencies(bds), 4);
        List<BuildDependency> dependencies = buildDependenciesDao.findDependenciesForModules(buildModulesDao.findModuleIdsForBuild(build14));
        Assert.assertEquals(dependencies.size(), 4);
    }
        ...
        for (BuildDependency dependency : dependencies) {
            switch ((int) dependency.getDependencyId()) {
                case 2001:
                    ...
                    assertEquals(dependency.getSha2(), null /*"a" + SHA2_SUFFIX*/);
                    break;
                case 2002:
                    ...
                    assertEquals(dependency.getSha2(), null /*"b" + SHA2_SUFFIX*/);
                    break;
                case 2021:
                ...
                case 2022:
                    ...
                    assertEquals(dependency.getSha2(), null /*"c" + SHA2_SUFFIX*/);
                    break;
                default:
    ...
    public void testFindBySha1() throws SQLException {
        assertFoundDependency1001(buildDependenciesDao.findDependenciesForChecksum(ChecksumType.sha1, "1" + SHA1_SUFFIX));
        List<BuildDependency> forSha1 = buildDependenciesDao.findDependenciesForChecksum(ChecksumType.sha1, "b" + SHA1_SUFFIX);
    ...
    //TODO [by dan]: kicked out build artifacts sha2 from db because of performance
/*    @Test(dependsOnMethods = {"testCreateSimpleDependency", "testCreateMultipleDependencies"})
    public void testFindBySha2() throws SQLException {
        assertFoundDependency1001(buildDependenciesDao.findDependenciesForChecksum(ChecksumType.sha256, null *//*"1" + SHA2_SUFFIX*//*));
        List<BuildDependency> forSha2 = buildDependenciesDao.findDependenciesForChecksum(ChecksumType.sha256, null *//*"b" + SHA2_SUFFIX*//*);
        Assert.assertEquals(forSha2.size(), 2);
        assertBuildDependenciesFromBuild12(forSha2);
    }*/
    ...
    public void testFindByMd5() throws SQLException {
        ...
        List<BuildDependency> forMd5 = buildDependenciesDao.findDependenciesForChecksum(ChecksumType.md5, "b" + MD5_SUFFIX);
        Assert.assertEquals(forMd5.size(), 2);
        assertBuildDependenciesFromBuild12(forMd5);
    }

    @Test(dependsOnMethods = {"testFindBySha1", "testFindByMd5"/*, "testFindBySha2"*/})
    public void testDeleteBuildDependencies() throws SQLException {
        Assert.assertEquals(buildDependenciesDao.deleteBuildDependencies(buildModulesDao.findModuleIdsForBuild(11L)), 1);
        Assert.assertEquals(buildDependenciesDao.deleteBuildDependencies(buildModulesDao.findModuleIdsForBuild(12L)), 4);
    }
}
