...
public abstract class BinaryServiceBaseTest extends DbBaseTest {
    ...
    //TODO [by dan][sha2]: add proper tests when binarystore switches to full sha2
    ...
    public void testReloadResourceWithoutSha2() throws IOException, SQLException {
        ...
        String sha1 = "19c58d1e008e4d23254e06ca1be7e8e3fdf165b3";
        String sha2 = "f8f50e9e769520f51f3fa4bf6629b1a86fc691738ac960e092e3f1d7c34fd052";
        String md5 = "0dfc8d01568eca152ad4a8ff94e66f2d";
        long length = 36L;

        BinaryInfo binaryInfo = dbService.invokeInTransaction("testLoadResources",
                () -> {
            addBinary(resourceName, sha1, sha2, md5, length);
            binaryStore.updateSha2ForSha1(sha1, "");
    ...
    private void createDummyNode(String resName, String sha1, String sha2, String md5, long length, long nodeId) throws SQLException {
    ...
    protected abstract BinaryInfo addBinary(String resName, String sha1, String sha2, String md5, long length) throws IOException;
    ...
    public void testGarbageOneByOne(String resName, String sha1, String sha2, String md5, long length, long nodeId) throws IOException, SQLException {
    ...
    public static long assertBinData(BinaryEntity binaryEntity, Object[] binData) {
        assertNotNull(binData);
        BinaryInfo info = new BinaryInfoImpl(binaryEntity.getSha1(), binaryEntity.getSha2(), binaryEntity.getMd5(), binaryEntity.getLength());
