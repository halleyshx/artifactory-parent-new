...
public class FileServiceSpecialCharsTest extends DbBaseTest {
    ...
    void insertBinaryEntry() throws IOException {
        ...
        try (InputStream resource = new ByteInputStream(new byte[]{1, 2, 3}, 3)) {
            BinaryInfo binaryInfo = binaryService.addBinary(binaryService.createBinaryStream(resource, null));
