...
public class ArchiveEntriesServiceImplTest extends DbBaseTest {
    ...
    public void insertEntriesReusedPathAndName() throws SQLException {
        ...
        String firstSha2 = randomSha2();
        binariesDao.create(new BinaryEntity(firstSha1, firstSha2, randomMd5(), 789));
        ...
        String secondSha2 = randomSha2();
        binariesDao.create(new BinaryEntity(secondSha1, secondSha2, randomMd5(), 4512));
    ...
    public void deleteKeepsPathAndName() throws SQLException {
        ...
        String archiveSha2 = randomSha2();
        binariesDao.create(new BinaryEntity(archiveSha1, archiveSha2, randomMd5(), 56));
