 ...
 * @author Lior Hasson
 */
public class StartArtifactoryTomcatDevWithAccessBundled {

    /**
     * Main function, starts the Tomcat server.
     */
    public static void main(String... args) throws IOException {
        File devArtHome = StartArtifactoryTomcatDev.getArtifactoryDevHome(args);
        ...
        StartArtifactoryTomcatDev.setSystemProperties(devArtHome);

        System.setProperty(ACCESS_DEBUG_PORT_PROP, ACCESS_DEFAULT_DEBUG_PORT);
        startAccessProcess(8340, true);

        Tomcat tomcat = StartArtifactoryTomcatDev.startTomcat(devArtHome);
