        ...
        try {
            ...
            if (user == null) {
                if (authenticationException != null) {
                    ...
                    if (userInfo != null) {
                        log.debug("Failed to authenticate user '{}' using ldap.", userInfo.getUsername());
            ...
            MutableUserInfo userInfo = InfoFactoryHolder.get()
                    .copyUser(userGroupService
                            .findOrCreateExternalAuthUser(userName, !usedLdapSetting.isAutoCreateUser(), usedLdapSetting.isAllowUserToAccessProfile()));
