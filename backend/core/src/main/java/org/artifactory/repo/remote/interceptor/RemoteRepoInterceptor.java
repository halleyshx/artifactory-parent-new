...
public interface RemoteRepoInterceptor {
     ...
     */
    void afterRemoteDownload(RepoResource remoteResource) throws RepoRejectException;
     ...
     */
    void resolveChecksumInformation(RepoPath repoPath, CloseableHttpResponse response, Set<ChecksumInfo> checksums);
