...
public class UploadServiceUtils {
    ...
    public static Properties populateItemPropertiesFromRequest(ArtifactoryRequest request, InputStream inputStream,
            RepoPath repoPath, AuthorizationService authService) {
        ...
        if (authService.canAnnotate(repoPath)) {
            ...
            if (isChecksumDeploy(request)){
                ...
                if(StringUtils.isNotBlank(sha256Checksum) && inputStream !=null && inputStream instanceof BinaryServiceInputStream) {
