...
public class CentralConfigServiceImplTest {
    ...
    private static CompoundVersionDetails earlyVersion = new CompoundVersionDetails(ArtifactoryVersion.v500, null, null,
            "EARLY_TEST", 0
    );
    private static CompoundVersionDetails recentVersion = new CompoundVersionDetails(ArtifactoryVersion.v522m001, null, null,
            "RECENT_TEST", 0
    );
    ...
    public void testSaveConfigAtFirstTime() throws InterruptedException {
        ...
        Thread.sleep(70); // File is written in background
